              ...
              <div className="modal-body">
                <form className="form-signin mx-auto">
                  ...
                  <div className="text-center">
                      <p>Não possui Login?<button onClick={setLogCadast(1)} className="btn btn-link">Cadastre-se aqui!</button></p>
                  </div>
                </form>
              </div>
            </div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form className="form-signin mx-auto">
                  ...
                  <button className="btn btn-lg btn-primary btn-block loginBtn my-2" onClick={autenticar} type="button">Entrar</button>
                  <div className="text-center">
                      <p>Não possui Login?<button onClick={setLogCadast(0)} className="btn btn-link">Cadastre-se aqui!</button></p>
                  </div>
                </form>
              </div>
            </div>
